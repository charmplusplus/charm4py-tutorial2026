...
| Chare Arrays | Learn about Chare arrays and associated communication primatives, including `broadcasts`, `reductions`, and `channels.`| [Ex2](), [Ex3](https://github.com/charmplusplus/charm4py-tutorial2026/tree/main/exercises/ex3-oddeven)| 
