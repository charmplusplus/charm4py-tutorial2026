...
class A(Chare):
    ...
    def work(self):
        ...
        # my current value is self.value, and my original value is self.orig
        # my index is self.idx, and I can communicate with my neighbors using self.left and self.right
        # here self.value = self.orig
        
        # TODO: implement odd-even sort in phases
